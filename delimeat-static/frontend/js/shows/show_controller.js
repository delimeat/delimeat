...
function ShowController($log, $location, $window, $translate, show) {
	...
	vm.timezones = [
	    {value:'Etc/GMT-5', i18n:'show.timezones.EST'},
	    {value:'America/Chicago', i18n:'show.timezones.CST'},
	    {value:'America/Los_Angeles', i18n:'show.timezones.PST'},
	    {value:'Asia/Tokyo', i18n:'show.timezones.JST'},
	    {value:'Australia/Sydney', i18n:'show.timezones.AET'},     
