...
@Test
	...
	public void feedResultValidatorsTest(){
		...
		Assert.assertEquals(mockedValidator, processor.getFeedResultValidators().get(0));
	}
	...
	public void validateFeedResultsTest() throws FeedValidationException{
		...
		List<FeedResult> outResults = processor.validateFeedResults(inResults, show);
...
@Test
  public void validatResultTorrentsTest() throws Exception{
      ...
      List<FeedResult> results = processor.validateResultTorrents( Arrays.asList(result1,result2,result3,result4,result5,result6), null, config);
