...
public class TvMazeJaxrsGuideDao_ImplTest {
	...
	public void infoTest() throws IOException, Exception {
		...
		Assert.assertEquals(GuideSource.TVRAGE, info.getGuideIds().get(1).getSource());
		Assert.assertEquals("432", info.getGuideIds().get(1).getValue());
		Assert.assertEquals(GuideSource.TVDB, info.getGuideIds().get(2).getSource());
		Assert.assertEquals("123", info.getGuideIds().get(2).getValue());
  ...
  @Test(expected=GuideNotFoundException.class)
	...
	public void searchTest() throws IOException, Exception {
		...
		Assert.assertEquals(GuideSource.TVRAGE, results.get(0).getGuideIds().get(1).getSource());
		Assert.assertEquals("432", results.get(0).getGuideIds().get(1).getValue());
		Assert.assertEquals(GuideSource.TVDB, results.get(0).getGuideIds().get(2).getSource());
		Assert.assertEquals("123", results.get(0).getGuideIds().get(2).getValue());
