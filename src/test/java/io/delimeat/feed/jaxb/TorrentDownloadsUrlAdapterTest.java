...
public class TorrentDownloadsUrlAdapterTest {

	private TorrentDownloadsUrlAdapter adapter;
	
	@Before
	public void setUp() throws Exception {
		adapter = new TorrentDownloadsUrlAdapter();
	}
	...
	public void unmarshallNonNumberTest() throws Exception{
		Assert.assertEquals("http://itorrents.org/torrent/INFO_HASH.torrent", adapter.unmarshal("INFO_HASH"));
	}
