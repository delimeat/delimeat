...
import io.delimeat.feed.BitSnoopJaxrsFeedDao_Impl;
...
public class BitSnoopJaxrsFeedDao_ImplTest {
	...
	private static final String METADATA = "META-INF/oxm/feed-bitsnoop-oxm.xml";
	...
	@Before
	public void setUp() {
		dao = new BitSnoopJaxrsFeedDao_Impl();
	}
