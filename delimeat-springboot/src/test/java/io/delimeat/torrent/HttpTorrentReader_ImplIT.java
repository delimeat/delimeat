...
public class HttpTorrentReader_ImplIT {
	...
	public void readTest() throws Exception {
		...
		server.stubFor(get(urlEqualTo("/"))
				...
				.withHeader("Referer", matching("http://localhost:8089"))
	...
	public void readNotFoundExceptionTest() throws Exception {
		...
		Assertions.assertEquals("HTTP response code 404 with message \"HTTP 404 Not Found\" for url http://localhost:8089",
				ex.getMessage());
	}
