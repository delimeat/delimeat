...
public class MagnetScrapeRequestHandler_ImplIT {
	...
	public void setUp() throws URISyntaxException {
		...
		scraper.setDefaultTracker(new URI("http://localhost:8089/scrape?test=true"));
	}
	...
	public void scrapeTest() throws URISyntaxException, Exception {
		...
		ScrapeResult result = scraper.scrape(new URI("magnet://test"), infoHash);
	...
	public void scrapeNotFoundExceptionTest() throws URISyntaxException, Exception {
		...
		TorrentNotFoundException ex = Assertions.assertThrows(TorrentNotFoundException.class, () -> {
			scraper.scrape(new URI("magnet://test"), infoHash);
		});
