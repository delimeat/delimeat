...
public class LimeTorrentsDataSource_Impl extends AbstractJaxrsFeedDataSource {

	public LimeTorrentsDataSource_Impl() {
		super(FeedSource.LIMETORRENTS, getProperties(), MediaType.APPLICATION_XML_TYPE);
	}
