...
public class InfoHashTest {
	...
	public void byteArrayConstructorTest() {
		...
		Assertions.assertEquals("601492e054f9540eb0129c35deb385baa2faf0fe", infoHash.getHex());
	}
	...
	public void getBytesTest() throws UnsupportedEncodingException {
		...
		Assertions.assertEquals("%60%14%92%E0T%F9T%0E%B0%12%9C5%DE%B3%85%BA%A2%FA%F0%FE", encodedInfoHash);
	}

	@Test
	public void nullEqualsTest() {
		InfoHash infoHash = new InfoHash("INFO_HASH".getBytes());
		Assertions.assertFalse(infoHash.equals(null));
	}

	@Test
	public void notInfoHashEqualsTest() {
		InfoHash infoHash = new InfoHash("INFO_HASH".getBytes());
		Assertions.assertFalse(infoHash.equals(new Object()));
	}

	@Test
	public void selfEqualsTest() {
		InfoHash infoHash = new InfoHash("INFO_HASH".getBytes());
		Assertions.assertTrue(infoHash.equals(infoHash));
	}
	...
	public void matchingEqualsTest() {
		...
		Assertions.assertTrue(infoHash.equals(infoHash1));
	}
	...
	public void notMatchingEqualsTest() {
		...
		Assertions.assertFalse(infoHash.equals(infoHash1));
	}

	@Test
	public void hashCodeTest() {
		Assertions.assertEquals(-358247363, new InfoHash("INFO_HASH".getBytes()).hashCode());
	}
	...
	public void toStringTest() {
		byte[] sha1Bytes = DelimeatUtils.hashBytes("INFO_HASH".getBytes(), "SHA-1");
		InfoHash infoHash = new InfoHash(sha1Bytes);
		Assertions.assertEquals("InfoHash [getHex()=601492e054f9540eb0129c35deb385baa2faf0fe]", infoHash.toString());
	}
