...
public class TorrentDownloadsDataSource_ImplTest {

	private TorrentDownloadsDataSource_Impl client;
	
	@BeforeEach
	public void setUp() {
		client = new TorrentDownloadsDataSource_Impl();
	}
	...
	public void feedSourceTest() {
		Assertions.assertEquals(FeedSource.TORRENTDOWNLOADS, client.getFeedSource());
	}
	...
	public void moxyPropertiesTest() {
		...
		Assertions.assertEquals("oxm/feed-torrentdownloads-oxm.xml", client.getMoxyProperties().get("eclipselink.oxm.metadata-source"));
	}
}
