...
public class LimeTorrentsDataSource_ImplTest {
	...
	public void feedSourceTest() {
		Assertions.assertEquals(FeedSource.LIMETORRENTS, client.getFeedSource());
	}
	...
	public void moxyPropertiesTest() {
		...
		Assertions.assertEquals("oxm/feed-limetorrents-oxm.xml", client.getMoxyProperties().get("eclipselink.oxm.metadata-source"));
	}
}
