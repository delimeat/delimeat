...
public class ZooqleDataSource_ImplTest {
	...
	public void feedSourceTest() {
		Assertions.assertEquals(FeedSource.ZOOQLE, client.getFeedSource());
	}
	...
	public void moxyPropertiesTest() {
		...
		Assertions.assertEquals("oxm/feed-zooqle-oxm.xml", client.getMoxyProperties().get("eclipselink.oxm.metadata-source"));
	}
}
