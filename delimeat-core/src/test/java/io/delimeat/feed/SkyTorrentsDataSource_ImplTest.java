...
public class SkyTorrentsDataSource_ImplTest {
	...
	public void feedSourceTest() {
		Assertions.assertEquals(FeedSource.SKYTORRENTS, client.getFeedSource());
	}
	...
	public void moxyPropertiesTest() {
		...
		Assertions.assertEquals("oxm/feed-skytorrents-oxm.xml", client.getMoxyProperties().get("eclipselink.oxm.metadata-source"));
	}
}
